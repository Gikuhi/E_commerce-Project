...
export default function Error(){
    ...
    <div className="sticky-header header-menu-center section section-fluid bg-white d-none d-xl-block">
        <div className="container">
            <div className="row align-items-center">
    ...
    <div id="offcanvas-mobile-menu" className="offcanvas offcanvas-mobile-menu">
        ...
        <div className="container">
            <div className="content-404">
                ...
                <div className="buttons">
                    <a className="btn btn-primary btn-outline-hover-dark" href="index.html">Go back</a>
                    <a className="btn btn-dark btn-outline-hover-dark" href="index.html">Homepage</a>
                </div>
            </div>
        </div>
    </div>
