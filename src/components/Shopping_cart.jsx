        ...
        <div className="container">
            <form className="cart-form" action="#">
                <table className="cart-wishlist-table table">
                    ...
                    <tbody>
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="assets/images/product/cart-product-1.webp" alt="cart-product-1"/></a></td>
                        ...
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="assets/images/product/cart-product-2.webp" alt="cart-product-2"/></a></td>
                        ...
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="assets/images/product/cart-product-3.webp" alt="cart-product-3"/></a></td>
