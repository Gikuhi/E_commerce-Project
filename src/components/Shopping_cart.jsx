        ...
        <div className="container">
            <form className="cart-form" action="#">
                <table className="cart-wishlist-table table">
                    ...
                    <tbody>
                        <tr>
                            <td className="thumbnail"><a href="/product_details"><img src="media/0faaceb4-98ed-419e-8927-bfbc9f464af2.jpeg" alt="cart-product-1"/></a></td>
                            ...
                            <td className="subtotal"><span>Ksh10000.00</span></td>
                            <td className="remove"><a href="#" className="btn">×</a></td>
                        </tr>
                        <tr>
                            <td className="thumbnail"><a href="/product_details"><img src="media/2f5a3e4b-e789-48cf-813e-73f6caa6ea97.jpeg" alt="cart-product-2"/></a></td>
                            ...
                            <td className="subtotal"><span>Ksh3500.00</span></td>
                            <td className="remove"><a href="#" className="btn">×</a></td>
                        </tr>
                        <tr>
                            <td className="thumbnail"><a href="/product_details"><img src="media/5 femmes qui ont marqué l'Histoire de l'Art _ Rise Art.jpeg" alt="cart-product-3"/></a></td>
                            ...
                            <td className="subtotal"><span>Ksh5000.00</span></td>
                            <td className="remove"><a href="#" className="btn">×</a></td>
                        </tr>
                    </tbody>
                </table>
                <div className="row justify-content-between mb-n3">
                    ...
                    <div className="col-auto">
                        <a className="btn btn-light btn-hover-dark mr-3 mb-3" href="/shop">Continue Shopping</a>
                ...
                <table>
                    <tbody>
                        <tr className="subtotal">
                            <th>Subtotal</th>
                            <td><span className="amount">Ksh18500.00</span></td>
                        </tr>
                        <tr className="total">
                            <th>Total</th>
                            <td><strong><span className="amount">Ksh18500.00</span></strong></td>
                        </tr>
                    </tbody>
                </table>
