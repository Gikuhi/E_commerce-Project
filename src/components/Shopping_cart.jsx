        ...
        <div className="container">
            <form className="cart-form" action="#">
                <table className="cart-wishlist-table table">
                    ...
                    <tbody>
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="public/assets/media/0faaceb4-98ed-419e-8927-bfbc9f464af2.jpeg" alt="cart-product-1"/></a></td>
                            <td className="name"> <a href="product-details.html">Jesus & Mary</a></td>
                        ...
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="public/assets/media/2f5a3e4b-e789-48cf-813e-73f6caa6ea97.jpeg" alt="cart-product-2"/></a></td>
                            <td className="name"> <a href="product-details.html">The Gateway</a></td>
                        ...
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="public/assets/media/5 femmes qui ont marqué l'Histoire de l'Art _ Rise Art.jpeg" alt="cart-product-3"/></a></td>
                            <td className="name"> <a href="product-details.html">Femmes Qui Ont</a></td>
                            ...
                            <td className="subtotal"><span>$50.00</span></td>
                            <td className="remove"><a href="#" className="btn">×</a></td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table>
                    <tbody>
                        <tr className="subtotal">
                            <th>Subtotal</th>
                            <td><span className="amount">$185.00</span></td>
                        </tr>
                        <tr className="total">
                            <th>Total</th>
                            <td><strong><span className="amount">$185.00</span></strong></td>
                        </tr>
                    </tbody>
                </table>
