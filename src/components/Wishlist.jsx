        ...
        <div className="container">
            <form className="cart-form" action="#">
                <table className="cart-wishlist-table table">
                    ...
                    <tbody>
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="assets/images/product/cart-product-1.webp" alt="wishlist-product-1"/></a></td>
                            <td className="name"> <a href="product-details.html">Walnut Cutting Board</a></td>
                        ...
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="assets/images/product/cart-product-2.webp" alt="wishlist-product-2"/></a></td>
                            <td className="name"> <a href="product-details.html">Lucky Wooden Elephant</a></td>
                            <td className="price"><span>£35.00</span></td>
                            <td className="add-to-cart"><a href="#" className="btn btn-light btn-hover-dark"><i className="fas fa-shopping-cart mr-2"></i>Add to Cart</a></td>
                            <td className="remove"><a href="#" className="btn">×</a></td>
                        </tr>
                        <tr>
                            <td className="thumbnail"><a href="product-details.html"><img src="assets/images/product/cart-product-3.webp" alt="wishlist-product-3"/></a></td>
                            <td className="name"> <a href="product-details.html">Fish Cut Out Set</a></td>
