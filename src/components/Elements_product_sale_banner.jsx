export default function Elements_product_sale_banner(){
    return<>
                    ...
                    <div className="sale-banner1" data-bg-image="assets/images/banner/sale/sale-banner1-1.webp">
                        <div className="inner">
                            ...
                            <h2 className="sale-percent">
                                <span className="number">40</span> % <br></br> off
                            </h2>
                    ...
                    <div className="sale-banner4">
                        <div className="inner">
                            ...
                            <div className="content">
                                ...
                                <a className="button-banner" href="shop.html"><img src="assets/images/banner/sale/sale-banner4-1.1.webp" alt="Sale Banner button"/></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="col-12 learts-mb-30">
                            <div className="sale-banner5">
                                <a href="#" className="inner">
                                    ...
                                    <div className="content">
                                        <h3 className="title">Holiday<br></br> Gifts</h3>
            ...
            <div className="row row-cols-lg-2 row-cols-1 learts-mb-n30">
                ...
                <div className="col learts-mb-30">
                    <div className="sale-banner8">
                        ...
                        <div className="content">
                            <h2 className="title">Little simple <br></br> things</h2>
                            <a href="#" className="link">shop now</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="col learts-mb-30">
                    <div className="sale-banner8">
                        ...
                        <div className="content">
                            <h2 className="title">Holiday <br></br> Gifts</h2>
                            <a href="#" className="link">shop now</a>
                        </div>
                    </div>
                </div>
