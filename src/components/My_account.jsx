            ...
            <div className="row learts-mb-n30">
                ...
                <div className="col-lg-4 col-12 learts-mb-30">
                    <div className="myaccount-tab-list nav">
                        ...
                        <a href="/login_register">Logout <i className="far fa-sign-out-alt"></i></a>
                    </div>
                </div>
                    ...
                    <div className="tab-content">
                        ...
                        <div className="tab-pane fade show active" id="dashboad">
                            <div className="myaccount-content dashboad">
                                <p>Hello <strong>didiv91396</strong> (not <strong>didiv91396</strong>? <a href="/login_register">Log out</a>)</p>
                                    ...
                                    <table className="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Pending</td>
                                                <td>$3000</td>
                                                <td><a href="/shopping_cart">View</a></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td>July 22, 2023</td>
