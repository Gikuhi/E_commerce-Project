export default function Elements_products_tabs(){
    return <>
                    ...
                    <div className="products row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div className="col">
                            <div className="product">
                                ...
                                <div className="product-info">
                                    <h6 className="title"><a href="product-details.html">Wooden Condiment Cups</a></h6>
                                    <span className="price">
                                        <span className="old">$45.00</span>
                                    <span className="new">$39.00</span>
                                    </span>
                        ...
                        <div className="col">
                            <div className="product">
                                ...
                                <div className="product-info">
                                    <h6 className="title"><a href="product-details.html">Pottery Bowl Set</a></h6>
                                    <span className="price">
                                        <span className="old">$45.00</span>
                                    <span className="new">$39.00</span>
                                    </span>
                        ...
                        <div className="col">
                            <div className="product">
                                ...
                                <div className="product-info">
                                    <h6 className="title"><a href="product-details.html">Hallmark Grandma Mug</a></h6>
                                    <span className="price">
                                        <span className="old">$45.00</span>
                                    <span className="new">$39.00</span>
                                    </span>
                        ...
                        <div className="col">
                            <div className="product">
                                ...
                                <div className="product-info">
                                    <h6 className="title"><a href="product-details.html">Round Tray Plate</a></h6>
                                    <span className="price">
                                        $100.00
                                    </span>
                                    <div className="product-buttons">
                        ...
                        <div className="col">
                            <div className="product">
                                ...
                                <div className="product-info">
                                    <h6 className="title"><a href="product-details.html">Steel Watering Can</a></h6>
                                    <span className="price">
                        ...
                        <div className="col">
                            <div className="product">
                                ...
                                <div className="product-info">
                                    <h6 className="title"><a href="product-details.html">Metal Wall Clock</a></h6>
                                    <span className="price">
                                        $200.00 - $250.00
                                    </span>
                                    <div className="product-buttons">
